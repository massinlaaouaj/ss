...
def main():
    ...
    try:
        ...
        logging.info(f"URI registrada en Config.insult_workers_manager.workers queue")
    ...
    try:
        ...
        logging.info(f"URI {insult_service_uri} liberada de Config.insult_workers_manager.workers queue")
